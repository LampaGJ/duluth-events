...
export const SOURCES: SourceDef[] = [
  ...
  },
  {
    ...
    adapter: "structured-api",
    mapper: "tribe-rest",
    url: "https://wildstatecider.com/wp-json/tribe/events/v1/events",
    type: "json-api",
    confidence: "high",
    enabled: true,
    notes: "CONFIRMED 2026-07-31 (33 upcoming). The Events Calendar REST, plain fetch, every event carrying venue 'Wild State Cider'. First-party Lincoln Park taproom calendar — drag nights, trivia, patio yoga, Sunday brunch. Found by re-sweeping venues whose place feed was empty or thin; docs/extraction-methods.md 'Empty/thin place-feed sweep 2026-07-31'.",
  },
  {
    name: "Spirit Mountain",
    adapter: "structured-api",
    mapper: "tribe-rest",
    url: "https://spiritmt.com/wp-json/tribe/events/v1/events",
    type: "json-api",
    confidence: "high",
    enabled: true,
    notes: "CONFIRMED 2026-07-31 (2 upcoming). The Events Calendar REST. Previously recorded as ready-but-empty in the 2026-07-24 sweep; it now returns real data, so this is the re-poll that sweep asked for. Thin by nature — a ski hill's winter programming is not in this API in July; re-check seasonally rather than assuming breakage.",
  },
  {
